...
const statusConfig = {
  ...
  checked_out: { label: "Completed", color: "border-[#A67C52]/45 dark:border-[#303631]/45 bg-[#EFEEE8] dark:bg-[#222823] text-[#183B35] dark:text-[#8FB8A8]" },
  cancelled: { label: "Cancelled", color: "border-red-200 dark:border-red-500/25 bg-red-50 text-red-600 dark:text-red-300" },
  expired: { label: "Expired", color: "border-slate-200 dark:border-[#303631] bg-slate-100 dark:bg-[#222823] text-slate-500 dark:text-[#A9AEA7]" },
};
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 pb-10">
      <div className="rounded-2xl border border-black/[0.06] dark:border-[#303631] bg-white dark:bg-[#1A1E1B] shadow-sm p-5">
        <div className="flex items-center gap-2 mb-4">
          <Bell className="w-4 h-4 text-[#183B35] dark:text-[#8FB8A8]" />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-[#F2EFE8] tracking-tight">Reservations</h1>
          <p className="text-sm text-slate-500 dark:text-[#A9AEA7] mt-1">Manage all guest reservations, check-ins, and payments</p>
        </div>
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {["checked_in"].includes(item.status) && (
                              <button
                                ...
                                disabled={updatingId === item._id}
                                className="px-2 py-1 text-[10px] rounded-lg border border-[#A67C52]/45 dark:border-[#303631]/45 bg-[#EFEEE8] dark:bg-[#222823] text-[#183B35] dark:text-[#8FB8A8] hover:bg-[#EFEAE1] transition-all disabled:opacity-50"
                              >
                                Check-out
                              </button>
                            )}
                            {["confirmed", "checked_in", "checked_out"].includes(item.status) && !item.isPaid && (
                              <button
                                ...
                                disabled={updatingId === item._id}
                                className="px-2 py-1 text-[10px] rounded-lg border border-[#A67C52]/45 dark:border-[#303631]/45 bg-[#EFEAE1] dark:bg-[#222823] text-[#183B35] dark:text-[#8FB8A8] hover:bg-[#EFEAE1] transition-all disabled:opacity-50"
                              >
                                Pay
                              </button>
                            )}
