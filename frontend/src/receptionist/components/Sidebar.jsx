...
const links = [
  { name: "Reservations", path: "/receptionist", icon: CalendarCheck, end: true },
  ...
  { name: "Services", path: "/receptionist/services", icon: Bell },
  { name: "Payments", path: "/receptionist/payments", icon: Wallet },
  { name: "Offers", path: "/receptionist/offers", icon: Tag },
  { name: "Reviews", path: "/receptionist/reviews", icon: MessageSquare },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full py-6">
        <Link to="/receptionist" className="flex items-center gap-3 px-6 mb-8">
            ...
            >
              {({ isActive }) => (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="receptionist-sidebar-active"
