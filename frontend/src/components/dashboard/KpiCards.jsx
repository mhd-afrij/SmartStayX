      ...
      {cards.map((card, i) => {
        ...
        return (
          <motion.div
            ...
            className="group relative rounded-2xl border border-black/[0.06] dark:border-[#303631] bg-white dark:bg-[#1A1E1B] overflow-hidden transition-all duration-300 hover:border-black/[0.1] dark:hover:border-[#303631] hover:shadow-[0_20px_60px_rgba(24,59,53,0.06)]"
          >
            <div
            ...
            <div className="relative z-10 p-5">
              ...
              <div className="flex items-end justify-between">
                <div>
                  <p className="text-xs font-medium text-slate-400 dark:text-[#A9AEA7] uppercase tracking-wider mb-1">
                    {card.label}
                  </p>
