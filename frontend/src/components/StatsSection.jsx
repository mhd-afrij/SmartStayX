    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(166,124,82,0.08),transparent_50%)]" />
          ...
          <div className="relative grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map((stat, i) => (
              ...
              >
                <p className="font-playfair text-4xl md:text-5xl text-[#183B35] dark:text-[#8FB8A8]">
                  {stat.value}
                </p>
                <p className="mt-1.5 text-sm uppercase tracking-[0.18em] text-slate-500 dark:text-[#A9AEA7]">
                  {stat.label}
                </p>
              </motion.div>
            ))}
