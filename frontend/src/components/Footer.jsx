...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-black/[0.06] pt-12 pb-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-wrap justify-between gap-12 md:gap-6">
          <div className="max-w-[300px]">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-black/[0.08] bg-black/[0.03] transition-transform hover:-translate-y-1">
          ...
          <div>
            <p className="font-space text-xs uppercase tracking-[0.28em] text-slate-400 mb-4">COMPANY</p>
          ...
          <div>
            <p className="font-space text-xs uppercase tracking-[0.28em] text-slate-400 mb-4">SUPPORT</p>
            <ul className="flex flex-col gap-3 text-sm text-slate-500">
          ...
          <div className="max-w-[300px]">
            <p className="font-space text-xs uppercase tracking-[0.28em] text-slate-400 mb-4">STAY UPDATED</p>
        ...
        <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
          <p className="text-xs text-slate-400">© {new Date().getFullYear()} SmartStayX. All rights reserved.</p>
          <ul className="flex items-center gap-6 text-xs text-slate-400">
            <li><a href="#" className="hover:text-slate-500 transition-colors">Privacy</a></li>
            <li><a href="#" className="hover:text-slate-500 transition-colors">Terms</a></li>
            <li><a href="#" className="hover:text-slate-500 transition-colors">Sitemap</a></li>
            <li><a href="#" className="hover:text-slate-500 transition-colors">Cookie Policy</a></li>
          </ul>
        </div>
      </div>
    </footer>
