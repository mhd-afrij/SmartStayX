...
const SignUp = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#F7F5F0] dark:bg-[#111412] px-4 pt-24 pb-16">
      <div className="absolute inset-0 opacity-70 [background:radial-gradient(circle_at_top_left,_rgba(24,59,53,0.08),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(24,59,53,0.06),_transparent_26%)]" />
