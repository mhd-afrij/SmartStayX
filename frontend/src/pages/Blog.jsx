    ...
    return (
      <section className="luxury-section min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          <h1 className="font-playfair text-4xl text-slate-900 dark:text-[#F2EFE8]">Destination not found</h1>
          <p className="text-slate-500 dark:text-[#A9AEA7]">The travel guide you are looking for does not exist yet.</p>
  ...
  return (
    <section className="pt-28 pb-16 md:pt-32 md:pb-20">
      <div className="mx-auto max-w-5xl px-6 md:px-10 space-y-12">
        ...
        >
          <h1 className="font-playfair text-4xl md:text-6xl text-slate-900 dark:text-[#F2EFE8] leading-tight">
            {data.title}
          </h1>
          <p className="mt-6 text-lg text-slate-600 dark:text-[#A9AEA7] leading-relaxed">{data.intro}</p>
        </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {data.highlights.map((item) => (
            ...
            >
              <p className="text-xs uppercase tracking-[0.2em] text-slate-400 dark:text-[#A9AEA7]">
                {item.label}
              </p>
              <p className="mt-2 font-playfair text-xl text-slate-900 dark:text-[#F2EFE8]">{item.value}</p>
            </motion.div>
          ))}
        </div>
      </div>
