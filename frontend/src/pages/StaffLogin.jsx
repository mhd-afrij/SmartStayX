...
const StaffLogin = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#fffaf4] dark:bg-[#0B1D24] px-4 pt-24 pb-16">
      <div className="absolute inset-0 opacity-70 [background:radial-gradient(circle_at_top,_rgba(80, 119, 179,0.08),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(80, 119, 179,0.05),_transparent_24%)]" />
