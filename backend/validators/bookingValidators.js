...
export const extendHoldBody = z.object({
  bookingId: z.string().min(1),
  extendMinutes: z.preprocess((v) => (v === undefined ? undefined : Number(v)), z.number().int().positive().max(60)).optional(),
});

export default { checkAvailabilityBody, createBookingBody, bookingIdBody, modifyBookingBody, paymentMethodBody, sessionIdBody, calculatePriceBody, extendHoldBody };
