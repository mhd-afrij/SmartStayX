          ...
          {previews.map((dest, i) => (
            ...
            >
              <Link
                ...
                className="group block overflow-hidden rounded-[24px] border border-white/10"
              >
                ...
                <div className="p-5">
                  <p className="font-playfair text-xl text-white group-hover:text-[#D4A85F] transition-colors">{dest.name}</p>
                  <p className="mt-2 text-sm text-white/60 line-clamp-2">{dest.description}</p>
