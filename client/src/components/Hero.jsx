      ...
      >
        ...
        >
          ...
          <h1 className="font-playfair mt-7 max-w-4xl text-[clamp(3rem,7vw,6.2rem)] leading-[0.95] tracking-[-0.05em] text-white">
            ...
            <span className="text-[#D4A85F]">Gateway</span> Destination
          </h1>
        ...
        >
          <motion.div
            ...
            className="luxury-card relative overflow-hidden p-4 md:p-6 shadow-[0_30px_100px_rgba(0,0,0,0.38)]"
          >
            <form onSubmit={handleSearch} className="relative space-y-4">
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-[1.45fr_1fr_1fr_0.9fr]">
                ...
                <label className="space-y-2">
                  ...
                  >
                    {[1, 2, 3, 4, 5, 6].map((n) => (
                      <option key={n} value={n} className="bg-[#0d1728]">
                        {n} Guest{n > 1 ? 's' : ''}
                      </option>
                    ))}
                  </select>
