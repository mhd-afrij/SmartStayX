...
const Navbar = () => {
    ...
    return (
            ...
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-4 lg:px-12 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6 backdrop-blur-md"}`}>

                {/* Logo */}
                <Link to='/'>
                 <img src={assets.logo} alt="logo" className={'h-20 ${isScrolled && "invert opacity-0"}'} />
