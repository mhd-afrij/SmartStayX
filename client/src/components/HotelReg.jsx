...
const HotelReg = () => {
  ...
  return (
    <div onClick={()=>setShowHotelReg(false)} className="fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70">
      ...
      <form onSubmit={onSubmitHandler} onClick={(e)=>e.stopPropagation()} className="flex bg-white rounded-xl md:max-w-4xl max-md:mx-2">
        <img
          src={assets.regImage}
          alt="reg-Image"
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className='w-full mt-4'>
            ...
            <input type="text" id='name' onChange={(e)=>setName(e.target.value)} value={name} placeholder="Type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required/>
             ...
             {/*Phone */}
            <label htmlFor='contact' className='font-medium text-gray-500 mt-4'>Phone</label>
            ...
            {/*Address */}
            <label htmlFor='address' className='font-medium text-gray-500 mt-4'>Address</label>
